...
public class FortuneWheelManager : MonoBehaviour
{
    ...
    public Button AdsTurnButton;               // This button is showed when you can turn the wheel for free
    ...
    private void TurnWheel(bool isFree)
    {
        ...
        if (!isFree)
        {
            AdsCurrencyManager.instance.SpendCurrency(CurrencyType.Common, TurnCost);
    ...
    public void TurnWheelButtonClick()
    {
        ...
        else
        {
            ...
            if (IsPaidTurnEnabled)
            {
                ...
                if (AdsCurrencyManager.instance.CanAfford(CurrencyType.Common, TurnCost))
                {
                    TurnWheelForCoins();
                }
            }
    ...
    public void TurnWheelButtonClickAds()
    {
        backButton.SetActive(false);
        AdsManager.instance.ShowRewardedAd(TurnWheelForFree);
    }
    ...
    private void ShowTurnButtons()
    {
        ...
        {                               // If haven't free turn
            ...
            {                           // If player can turn for coins
                ...
                if (_isStarted || !AdsCurrencyManager.instance.CanAfford(CurrencyType.Common, TurnCost))
    ...
    public void RewardCommonCoins(int cc)
    {
        AdsCurrencyManager.instance.EarnCurrency(CurrencyType.Common, cc);
        UpdateCurrencyUI();
    }
    public void RewardRareCoins(int rc)
    {
        AdsCurrencyManager.instance.EarnCurrency(CurrencyType.Rare, rc);
        UpdateCurrencyUI();
    }
    ...
    private void ShowFreeTurnButton()
    {
        ...
        AdsTurnButton.gameObject.SetActive(false);
    }
    ...
    private void ShowPaidTurnButton()
    {
        ...
        AdsTurnButton.gameObject.SetActive(true);
